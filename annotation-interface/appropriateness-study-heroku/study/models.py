...
class StudyPost(models.Model):
    ...
    rewrite_a = models.TextField(max_length=10000, null=False, default="Rewrite_a")
    rewrite_b = models.TextField(max_length=10000, null=False, default="Rewrite_b")
    issue = models.TextField(max_length=500, null=False, default="Issue")
    batch = models.IntegerField(null=True)
    edits_a = models.JSONField(default=list, null=True, blank=True)  # Store edits for rewrite_a
    edits_b = models.JSONField(default=list, null=True, blank=True)  # Store edits for rewrite_b
