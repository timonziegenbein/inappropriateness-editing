...
def fuzzy_post_process_edits(edits):
    ...
    for edit in edits:
        for i, edit_action in enumerate(edit['edit_actions']):
            ...
            edit["reason"] = "Other Reasons"
            if edit_action['type'] == 'R':
                edit["inappropriate_part"] = edit_action['before']
                edit["rewritten_part"] = edit_action['after']
            elif edit_action['type'] == 'A':
                edit["inappropriate_part"] = ""
                edit["rewritten_part"] = edit_action['after']
            elif edit_action['type'] == 'D':
                edit["inappropriate_part"] = edit_action['before']
                edit["rewritten_part"] = ""

            if edit not in final_edits:
