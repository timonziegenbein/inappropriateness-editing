...
class Perplexity(evaluate.Measurement):
    def __init__(self, model_id, device=None, *args, **kwargs):
        ...
        # Set pad token if not set (needed for padding=True in tokenizer call)
    ...
    def _compute(
        self, data, batch_size: int = 16, add_start_token: bool = True, max_length=None
    ):
