...
def main():
    ...
    parser.add_argument("--output_file", type=str, default="scorers/local_scorers/pattern_conformity/data/gemini_predictions.jsonl",
    ...
    print(f"       --output scorers/local_scorers/pattern_conformity/data/gemini_with_edits.jsonl \\")
