...
def main():
    ...
    output_file = "scorers/local_scorers/pattern_conformity/data/coedit_predictions.jsonl"
    batch_size = 8
    max_length = 256
    ...
    print(f"       --output scorers/local_scorers/pattern_conformity/data/coedit_with_edits.jsonl \\")
