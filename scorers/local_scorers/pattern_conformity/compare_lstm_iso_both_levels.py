...
def main():
    ...
    iso_edit_path = Path("scorers/local_scorers/pattern_conformity/outputs/iso_only_token_features.json")
    iso_strategy_path = Path("scorers/local_scorers/pattern_conformity/outputs/per_sentence_iso_only_token_features.json")
