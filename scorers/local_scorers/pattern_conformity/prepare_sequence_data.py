...
def main():
    ...
    logger.info("="*80)
    logger.info("\nNext steps:")
    logger.info("1. Train LSTM: python scorers/local_scorers/pattern_conformity/train_lstm_scorer.py")
    logger.info("2. Compare HMM vs LSTM: python scorers/local_scorers/pattern_conformity/compare_lstm_hmm.py")
