"""
Calculate separation metrics for PER-SENTENCE analysis (editing strategy).
"""
import json
import numpy as np
...
def main():
    ...
    approaches = [
        ...
        ('HMM-as-ISO-feat', script_dir / 'outputs' / 'per_sentence_hmm_as_iso_feature_only.json'),
    ...
    # Print results
    print("=" * 100)
    print("PER-SENTENCE SEPARATION METRICS: Human vs Models (Editing Strategy)")
    print("=" * 100)
    print()
