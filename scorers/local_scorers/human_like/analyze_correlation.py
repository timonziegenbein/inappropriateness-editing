"""
Analyze correlation and agreement between all human-like scorer approaches.
"""
...
# Open output file
output_file = script_dir / "outputs" / "correlation_analysis.txt"
with open(output_file, 'w') as f:
    ...
    log("="*80)
    log("CORRELATION ANALYSIS: All Human-Like Scorer Approaches")
    log("="*80)
    log("")
