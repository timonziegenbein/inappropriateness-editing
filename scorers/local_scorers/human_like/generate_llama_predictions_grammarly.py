...
def main():
    ...
    parser.add_argument("--output_file", type=str, default="scorers/local_scorers/human_like/data/llama_predictions.jsonl",
    ...
    print(f"       --output scorers/local_scorers/human_like/data/llama_with_edits.jsonl \\")
