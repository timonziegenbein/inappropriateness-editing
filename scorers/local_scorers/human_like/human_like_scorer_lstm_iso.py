"""
Dual-Component Human-Like Scorer

Uses TWO independent trained models to score edit human-likeness:
...
Both components must pass their thresholds for an edit to be considered human-like.
...
class HumanLikeScorer:
    def __init__(self, device,
                 model_path="scorers/local_scorers/human_like",
                 iso_threshold=0.186,
                 lstm_threshold=3.076,
                 max_len=None):
        """
        Initialize Dual-Component Human-Like Scorer (Edit-Level).
        ...
        logger.info(f"Loaded Dual-Component HumanLikeScorer:")
    ...
    def _compute_lstm_score(self, sequence: List[str]) -> float:
        ...
        Lower perplexity = more human-like (more predictable given training data).
    ...
    def _compute_iso_score(self, sequence: List[str]) -> float:
        ...
        Returns:
            Score in [0, 1] where higher = more human-like (less anomalous)
        """
        ...
        # We need to map this to [0, 1] where 1 = most human-like
    ...
    def calculate_human_likeness(self, original_argument: str, original_sentence: str,
        ...
        """
        Calculate human-likeness reward for an edit using BOTH components.
