"""
Compute human-likeness scores using hybrid HMM + Isolation Forest approach.
...
def compute_hybrid_score(original: str, edits: List[Dict[str, Any]], hmm_model, iso_model, operation_vocab, tokenizer, alpha=None, hmm_as_feature_only: bool = False, return_prediction: bool = False):
    ...
    Returns:
        If return_prediction=False: Score (higher = more human-like), or None for no-edits
    ...
    # Higher values = more normal (human-like)
