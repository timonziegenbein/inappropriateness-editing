#!/usr/bin/env python3
"""
Train LSTM-based sequence model for human-like edit scoring.
...
class LSTMSequenceModel(nn.Module):
    ...
    def compute_perplexity(self, x, lengths):
        """
        Compute perplexity of sequences (lower = more human-like).
...
if __name__ == "__main__":
    ...
    if args.per_sentence:
        ...
        output_path = Path("scorers/local_scorers/human_like/models/lstm_model_per_sentence.pt")
        ...
        output_path = Path("scorers/local_scorers/human_like/models/lstm_model.pt")
